...
**Proyecto: Face Runner – Unity + AR Foundation**

**Asignatura:** Realidad Aumentada / Desarrollo de Videojuegos  
**Tipo de evaluación:** Proyecto práctico  
**Puntuación total:** 100 puntos (+ bonus)
...
| **Insuficiente (0–7)** | El face tracking no controla correctamente al personaje o no usa AR Face Manager. |
...
| **Insuficiente (0–7)** | Movimiento incorrecto o incompleto que impide jugar correctamente. |
...
| **Insuficiente (0–7)** | No existen enemigos funcionales o las colisiones fallan. |
...
| **Insuficiente (0–7)** | No existe sistema de puntuación funcional. |
...
| **Insuficiente (0–9)** | Interfaz incompleta, confusa o inexistente. |
...
| **Insuficiente (0–4)** | Código desorganizado, errores graves o falta de entregables. |

---

## 🌟 8. Creatividad y Funcionalidades Extra (BONUS hasta +5 puntos)

> **Este apartado permite subir nota, pero no penaliza si no se implementa.**
...
| Nivel | Descripción |
|------|------------|
| **Excelente (+5)** | Varias mejoras bien integradas y coherentes con el juego. |
| **Notable (+3–4)** | Alguna mejora extra bien implementada. |
| **Aprobado (+1–2)** | Mejora menor o poco integrada. |
| **Sin bonus (0)** | No se incluyen funcionalidades extra. |

---

## 📌 Observaciones finales

- El proyecto debe ser **funcional en un dispositivo Android compatible**.
- Los apartados opcionales permiten alcanzar las calificaciones más altas.
- El uso de assets externos debe estar correctamente citado.
